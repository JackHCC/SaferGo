...
//import xin.skingorz.isafety.Location;
//import xin.skingorz.isafety.LocationToServer;
//
//public class Maintabs_BActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
//
//    public MapView mMapView = null;
//    private Location location = new Location();
//    private LocationToServer locationToServer = new LocationToServer(location);
//    private Location locationProtect;
//    AMap aMap;
...
//        setMap();
//
//        locationProtect = locationToServer.getLocation();
//
//
//
//        LatLng latLng = new LatLng(39.987422,116.353818);
//
//        final Marker marker = aMap.addMarker(new MarkerOptions().position(latLng).title("北京").snippet("DefaultMarker"));
//        marker.getGeoPoint();
//
////        if (locationProtect != null) {
////
////
////            LatLng latLng = new LatLng(locationProtect.getLatitude(), locationProtect.getLongitude());
////
////            final Marker marker = aMap.addMarker(new MarkerOptions().position(latLng).title("北京").snippet("DefaultMarker"));
////            marker.getGeoPoint();
//////            //设置缩放级别
...
//////            //将地图移动到定位点
//////            aMap.moveCamera(CameraUpdateFactory.changeLatLng(new LatLng(locationProtect.getLatitude(), locationProtect.getLongitude())));
...
//
//
//        Button btn_protect = (Button) findViewById(R.id.protect);
//
...
//            location.setProvice(aMapLocation.getProvince());
...
//            locationToServer.setLocation(location);
//            locationToServer.sendLocation();
//
//
...
public class Maintabs_BActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setIcon(BitmapDescriptorFactory.fromBitmap(BitmapFactory
                .decodeResource(getResources(),R.drawable.protect)));
        marker.setTitle("好朋友");*/
